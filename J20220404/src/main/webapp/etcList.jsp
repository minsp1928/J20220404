...
<title>잡담 게시판</title>
<head>
<link rel="stylesheet" type="text/css" href="css/reListStyle.css?=1">
...
<section>
	<div class="bars">
		...
		<table id="bar">
			<tr>
				...
				<td class="t2"><a href="foodList.do?com_type=103">식단</a> </td>
				<td class="t1"><a href="etcList.do?com_type=104">잡담</a></td>
			</tr>
		</table>
		<div class="w">
   ...
   <div style="text-align: center;">
      <c:if test="${startPage > blockSize }">
         <a href='etcList.do?pageNum=${startPage-blockSize }'>[이전]</a>
      </c:if>
      <c:forEach var="i" begin="${startPage }" end="${endPage }">
         <a href='etcList.do?pageNum=${i}'>[${i}]</a>
      </c:forEach>
      <c:if test="${endPage<pageCnt }">
         <a href='etcList.do?pageNum=${startPage-blockSize }'>[다음]</a>
      </c:if>
   </div>
