...
<section>
   <div class="bars">
      ...
      <table id="bar">
         <tr>
            ...
            <td class="t1"><a href="qaList.do?com_type=102"> 질문</a></td>
            <td class="t2"><a href="foodList.do">식단</a> </td>
            <td class="t2"><a href="etcList.do">잡담</a></td>
         </tr>
      </table>
      <div class="w">
   ...
   <div style="text-align: center;">
      <c:if test="${startPage > blockSize }">
         <a href='qaList.do?pageNum=${startPage-blockSize }'>[이전]</a>
      </c:if>
      <c:forEach var="i" begin="${startPage }" end="${endPage }">
         <a href='qaList.do?pageNum=${i}'>[${i}]</a>
      </c:forEach>
      <c:if test="${endPage<pageCnt }">
         <a href='qaList.do?pageNum=${startPage-blockSize }'>[다음]</a>
      </c:if>
   </div>
